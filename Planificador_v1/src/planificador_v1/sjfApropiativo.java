...
public class sjfApropiativo extends javax.swing.JFrame {
    ...
    public int[][] data = new int[50][4]; // proceso, rafaga, llegada, estado
    public int[][] copia = new int[50][4]; // proceso, rafaga, llegada, estado
    public int[][] resumen = new int[50][4]; // proceso, inicio, finalizado, rafagas
    public int[][] resumenTabla = new int[50][4]; // proceso, T_entrega, T_respuesta, T_espera
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Apropiativo SJF");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(TxtTiempoLlegada, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void Btn_AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_AgregarActionPerformed
        ...
        if ((TxtTiempoRafaga.getText().equals("")) || (TxtTiempoLlegada.getText().equals(""))){
            String e = null;
            JOptionPane.showMessageDialog(null, "Ráfaga o Llegada no puede estar vacío " + e);
        }else{
    ...
    private void BtnEjemploActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEjemploActionPerformed
        ...
        Object[] miTabla = new Object[3]; //Creo un Objeto de tres campos
        miTabla[0] = contador; //el proceso será igual al contador
        miTabla[1] = "8"; //se guarda la rafaga ingresada
        ...
        miTabla[2] = "1"; //se guarda el tiempo de llegada
        modelo.addRow(miTabla); //Se agrega un nuevo registro a la tabla y se envia el objeto creado
        Tbl_TablaInicial.setModel(modelo); //se pasa el modelo a la tabla...
        ...
        miTabla[2] = "2"; //se guarda el tiempo de llegada
        modelo.addRow(miTabla); //Se agrega un nuevo registro a la tabla y se envia el objeto creado
        Tbl_TablaInicial.setModel(modelo); //se pasa el modelo a la tabla...
        ...
        miTabla[2] = "3"; //se guarda el tiempo de llegada
        modelo.addRow(miTabla); //Se agrega un nuevo registro a la tabla y se envia el objeto creado
        Tbl_TablaInicial.setModel(modelo); //se pasa el modelo a la tabla...
    ...
    private void BtnVerGraficoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerGraficoActionPerformed
        ...
        TxtPane.setText("");
        insertarImagen("c:/Salida/sfj.jpg");
    ...
    public void operar(){
        ...
        for (int j = 0; j < sumaTiempos; j++) {
            
            for (int i = 0; i < contador; i++) { //Recorre los seis registros
                if(data[i][2] <= tiempos){ //Hay alguna llegada igual a la llegada correlativa?
                    if((data[i][1] > 0) && (data[i][2] == 0)){ //Rafaga debe estar mayor a cero y valor de llegada sea igual a 0
                        rafagaPeque = data[i][1]; //capturar el valor de la ráfaga
                        posicion = data[i][0]; //capturar posicion del proceso
                    }else if((data[i][1] > 0) && (data[i][1] < rafagaPeque)){ //Si rafaga es mayor a cero y si rafaga es mejor que la última ráfaga más peque encontrada
                        rafagaPeque = data[i][1]; //capturar el valor de la ráfaga
                        posicion = data[i][0]; //capturar posicion del proceso
                    }
                }
                //System.out.println(data[i][2] <= tiempos);
                //System.out.println((data[i][1] > 0) + " -- " +  (data[i][2] == 0));
                //System.out.println((data[i][1] > 0) + " ---- " + (data[i][1] < rafagaPeque));
                //System.out.println(rafagaPeque);
            ...
            System.out.println("Tiempo: " + Integer.toString(tiempos) + " => " + Integer.toString(tiempos+1));
            System.out.println("P: " + Integer.toString(data[posicion-1][0]));
            System.out.println("Valor actual: " + Integer.toString(data[posicion-1][1]));

            data[posicion-1][1] = data[posicion-1][1] - 1;

            System.out.println("P: " + Integer.toString(data[posicion-1][0]));
            System.out.println("Nuevo valor: " + Integer.toString(data[posicion-1][1]));
            System.out.println("______________________________");
            //FINALIZA VER RESULTADOS EN CONSOLA*************************************
            ...
            //CERO para sacar de la lista y UNO para que permanezca en la lista
            if (data[posicion-1][1]==0){
                data[posicion-1][3]=0;
            }
    ...
    public void Dibujar(){
        ...
        String fileInputPath = "c:\\Salida\\sfj.txt";

        String fileOutputPath = "c:\\Salida\\sfj.jpg";
    ...
    public void Resumen(){
        ...
        for (int i = 0; i < contador; i++) {
            ...
            resumenTabla[i][3]=(resumen[i][2]-copia[i][2])-copia[i][1]; //calcular T_Espera: (finalizado - llegada)-rafaga
    ...
    public void Limpiar(){
        ...
        Tbl_TablaInicial.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Proceso", "T_Rafaga", "T_Llegada" //Encabezados para la tabla
            }
        ));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sjfApropiativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sjfApropiativo().setVisible(true);
            }
        });
